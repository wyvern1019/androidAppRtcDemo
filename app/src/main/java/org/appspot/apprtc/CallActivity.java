...
public class CallActivity extends Activity implements AppRTCClient.SignalingEvents,
    ...
    @Override
    public void onAudioRecordCallback(double[] data) {
        runOnUiThread(() -> hudFragment.updateAudioRecordData(data));
    }

    @Override
    public void onAudioTrackCallback(double[] data) {
        runOnUiThread(() -> hudFragment.updateAudioTrackData(data));
    }
