...
public class JavaAudioDeviceModule implements AudioDeviceModule {
    ...
    public static class Builder {
        ...
        private AudioTrackDataCallback audioTrackDataCallback;
        ...
        public Builder setAudioTrackDataCallback(AudioTrackDataCallback audioTrackDataCallback) {
            this.audioTrackDataCallback = audioTrackDataCallback;
            return this;
        }
        ...
        public AudioDeviceModule createAudioDeviceModule() {
            ...
            final WebRtcAudioRecord audioInput = new WebRtcAudioRecord(context, audioManager, audioSource,
                audioFormat, audioRecordErrorCallback, audioRecordStateCallback, samplesReadyCallback, audioRecordDataCallback,
                useHardwareAcousticEchoCanceler, useHardwareNoiseSuppressor);
            final WebRtcAudioTrack audioOutput = new WebRtcAudioTrack(
                context, audioManager, audioTrackErrorCallback, audioTrackStateCallback, audioTrackDataCallback);
    ...
    public static interface AudioRecordDataCallback {
        void onWebRtcAudioRecordData(byte[] data);
    }
    ...
    public static interface AudioTrackDataCallback {
        void onWebRtcAudioTrackData(byte[] data);
    }
