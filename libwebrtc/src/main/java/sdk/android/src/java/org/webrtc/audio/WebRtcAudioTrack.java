...
class WebRtcAudioTrack {
    ...
    private final @Nullable
    AudioTrackDataCallback audioTrackDataCallback;
        ...
        public void run() {
            ...
            while (keepAlive) {
                ...
                if (bytesWritten != sizeInBytes) {
                    ...
                    if (audioTrackDataCallback != null) {
                        byte[] result = byteBuffer.array();
                        audioTrackDataCallback.onWebRtcAudioTrackData(result);
                    }
                }
    ...
    WebRtcAudioTrack(Context context, AudioManager audioManager,
                     ...
                     @Nullable AudioTrackDataCallback audioTrackDataCallback) {
